	...
	public static void main(String a[]) {
		...
		do {
			...
			case 4:
				...
				break;
			case 5:
				System.out.println("enter the contact no to delete patient details");
			...
			case 6:
				...
				break;
			case 7:
				System.out.println("enter the existing name to get contact number");
				String exstingName = sc.next();
				System.out.println(hos.getPatientContactNoByName(exstingName));
				break;
			case 8:
				System.out.println("Enter the Gender to delete patient details");
				String ge1 = sc.next();
